...
export const textOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: "Classify if a text violates Hackai's content policy",
				routing: {
					request: {
						method: 'POST',
						url: '/v1/moderations',
...
const editOperations: INodeProperties[] = [
	{
		...
		name: 'model',
		type: 'options',
		description: 'The model which will generate the edited version',
		displayOptions: {
			show: {
				operation: ['edit'],
				resource: ['text'],
...
const moderateOperations: INodeProperties[] = [
	{
		...
		name: 'model',
		type: 'options',
		description: 'The model which will classify the text',
		displayOptions: {
			show: {
				resource: ['text'],
				operation: ['moderate'],
